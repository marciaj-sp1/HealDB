...
from src.repositories.create_medications_repository import create_medications_repository
from src.repositories.create_diseases_repository import create_diseases_repository
from src.repositories.create_symptoms_repository import create_symptoms_repository
from src.repositories.create_activeingr_repository import create_activeingr_repository
...
def main():
    ...
    try:
        ...
        for func, func_name in [
            (create_medications_repository, "create_medications_repository"),
            (create_diseases_repository, "create_diseases_repository"),
            (create_symptoms_repository, "create_symptoms_repository"),
            (create_activeingr_repository, "create_activeingr_repository"),
            (create_leaflets_repository, "create_leaflets_repository"),
            (create_drugbank_repository, "create_drugbank_repository")
        ]:
