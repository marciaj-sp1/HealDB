...
#from interoperability.linking.link_drugbank_to_active_ing import link_drugbank_to_active_ing
...
#from interoperability.linking.validate_wikidata_pubchem import validate_wikidata_pubchem
#from interoperability.linking.validate_wikidata_chebi import validate_wikidata_chebi
...
def main():
    ...
    try:
        ...
        for func, func_name in [
            ...
            #(link_drugbank_to_active_ing, "link_drugbank_to_active_ing"),
            ...
            #(validate_wikidata_pubchem, "validate_wikidata_pubchem"),
            #(validate_wikidata_chebi, "validade_wikidata_chebi"),
