...
write_json(result_healdb, "C:/project/healdb/data/output/interoperability/iucn/iucn_conservation_healdb_r.json", pretty = TRUE, auto_unbox = TRUE)
write_json(result_dcb, "C:/project/healdb/data/output/interoperability/iucn/iucn_conservation_dcb_r.json", pretty = TRUE, auto_unbox = TRUE)
